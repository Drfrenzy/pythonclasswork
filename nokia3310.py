...
def options():
	print(''' 
		...
		''')
	options_userinput = int(input("Select an option: "))
...
def message_settings():
	print(''' 
		...
		''')
	message_settings_userinput = int(input("Select an option: "))
...
def set1():
	print(''' 
		...
		''')
	set1_userinput = int(input("Select an option: "))
...
def common():
	print(''' 
		...
		''')
	common_userinput = int(input("Select an option: "))
...
def show_call_duration():
	print(''' 
		...
		''')
	show_call_duration_userinput = int(input("Select an option: "))
...
def show_call_cost():
	print(''' 
		...
		''')
	show_call_cost_userinput = int(input("Select an option: "))
...
def call_cost_settings():
	print(''' 
		...
		''')
	call_cost_settings_userinput = int(input("Select an option: "))
...
def call_settings():
	print(''' 
		...
		''')
	call_settings_userinput = int(input("Select an option: "))
...
def phone_settings():
	print(''' 
		...
		''')
	phone_settings_userinput = int(input("Select an option: "))
...
def security_settings():
	print(''' 
		...
		''')
	security_settings_userinput = int(input("Select an option: "))
